...
# -----------------------------------------------------
# Faster Scene Generation (smaller scene for speed)
# -----------------------------------------------------
def faster_random_scene():
    world = HittableList()
    ...
    # Fewer random small spheres (from -4 to 4 instead of -11 to 11)
    for a in range(-4, 5):
        for b in range(-4, 5):
...
# -----------------------------------------------------=
def main():
    # Image settings (reduced for speed)
    aspect_ratio = 3.0 / 2.0
    image_width = 300          # Reduced resolution
    image_height = int(image_width / aspect_ratio)
    samples_per_pixel = 25     # Fewer samples per pixel
    max_depth = 10             # Lower recursion depth

    # World
    world = faster_random_scene()
    ...
    for j in range(image_height - 1, -1, -1):
        print(f"Scanlines remaining: {j+1}", end='\r')
        for i in range(image_width):
            ...
            pixels[i, image_height - 1 - j] = (ir, ig, ib)

    img.save("faster_scene.png")
    print("\nDone! Saved to faster_scene.png")
